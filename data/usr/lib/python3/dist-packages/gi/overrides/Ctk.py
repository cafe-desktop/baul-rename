...
Ctk = get_introspection_module('Ctk')
CTK2 = Ctk._version == '2.0'
CTK3 = Ctk._version == '3.0'
CTK4 = Ctk._version == '4.0'
...
if CTK2:
    warn_msg = "You have imported the Ctk 2.0 module.  Because Ctk 2.0 \
...
port your app to Ctk 3 or greater. PyCTK is the recomended \
python module to use with Ctk 2.0"

    warnings.warn(warn_msg, RuntimeWarning)


class PyCTKDeprecationWarning(PyGIDeprecationWarning):
    pass


__all__.append('PyCTKDeprecationWarning')
...
if CTK2 or CTK3:
    def _construct_target_list(targets):
        ...
        for entry in targets:
            if not isinstance(entry, Ctk.TargetEntry):
                entry = Ctk.TargetEntry.new(*entry)
...
class Widget(Ctk.Widget):

    translate_coordinates = strip_boolean_result(Ctk.Widget.translate_coordinates)
    ...
    if CTK2 or CTK3:
        def drag_dest_set_target_list(self, target_list):
            if (target_list is not None) and (not isinstance(target_list, Ctk.TargetList)):
                target_list = Ctk.TargetList.new(_construct_target_list(target_list))
    ...
    if CTK2 or CTK3:
        def style_get_property(self, property_name, value=None):
            ...
            Ctk.Widget.style_get_property(self, property_name, value)
...
if CTK2 or CTK3:
    class Container(Ctk.Container, Widget):
        ...
        def child_get_property(self, child, property_name, value=None):
            ...
            Ctk.Container.child_get_property(self, child, property_name, value)
            return value.get_value()
        ...
        get_focus_chain = strip_boolean_result(Ctk.Container.get_focus_chain)
...
class Editable(Ctk.Editable):

    def insert_text(self, text, position):
        return super(Editable, self).insert_text(text, -1, position)

    get_selection_bounds = strip_boolean_result(Ctk.Editable.get_selection_bounds, fail_ret=())
...
if CTK2 or CTK3:
    class Action(Ctk.Action):
        __init__ = deprecated_init(Ctk.Action.__init__,
                                   arg_names=('name', 'label', 'tooltip', 'stock_id'),
                                   category=PyCTKDeprecationWarning)

    Action = override(Action)
    __all__.append("Action")

    class RadioAction(Ctk.RadioAction):
        __init__ = deprecated_init(Ctk.RadioAction.__init__,
    ...
    class ActionGroup(Ctk.ActionGroup):
        __init__ = deprecated_init(Ctk.ActionGroup.__init__,
                                   arg_names=('name',),
                                   category=PyCTKDeprecationWarning)
        ...
        def add_actions(self, entries, user_data=None):
            ...
            of ctk.Action  objects based on the information in the list of action
            ...
            following information:
                ...
                * The accelerator for the action, in the format understood by the
                  ctk.accelerator_parse() function. Optional with a default value of
                  None.
        ...
        def add_toggle_actions(self, entries, user_data=None):
            ...
            number of ctk.ToggleAction objects based on the information in the list
            ...
            def _process_action(name, stock_id=None, label=None, accelerator=None, tooltip=None, callback=None, is_active=False):
                action = Ctk.ToggleAction(name=name, label=label, tooltip=tooltip, stock_id=stock_id)
        ...
        def add_radio_actions(self, entries, value=None, on_change=None, user_data=None):
            ...
            number of ctk.RadioAction objects based on the information in the list
            of action entry tuples contained in entries and adds them to the action
    ...
    class UIManager(Ctk.UIManager):
        def add_ui_from_string(self, buffer):
            ...
            return Ctk.UIManager.add_ui_from_string(self, buffer, length)

        def insert_action_group(self, buffer, length=-1):
            return Ctk.UIManager.insert_action_group(self, buffer, length)

    UIManager = override(UIManager)
    __all__.append('UIManager')


class ComboBox(Ctk.ComboBox, Container):
    get_active_iter = strip_boolean_result(Ctk.ComboBox.get_active_iter)
...
if CTK2 or CTK3:
    class Box(Ctk.Box):
        __init__ = deprecated_init(Ctk.Box.__init__,
...
if CTK2 or CTK3:
    class SizeGroup(Ctk.SizeGroup):
        __init__ = deprecated_init(Ctk.SizeGroup.__init__,
                                   arg_names=('mode',),
                                   deprecated_defaults={'mode': Ctk.SizeGroupMode.VERTICAL},
                                   category=PyCTKDeprecationWarning)
...
if CTK2 or CTK3:
    class MenuItem(Ctk.MenuItem):
        __init__ = deprecated_init(Ctk.MenuItem.__init__,
                                   arg_names=('label',),
                                   category=PyCTKDeprecationWarning)
...
class Builder(Ctk.Builder):
    ...
    def add_from_string(self, buffer):
        ...
        return Ctk.Builder.add_from_string(self, buffer, length)
    ...
    def add_objects_from_string(self, buffer, object_ids):
        ...
        return Ctk.Builder.add_objects_from_string(self, buffer, length, object_ids)
...
if CTK4:
    _window_init = Ctk.Window.__init__
else:
    _window_init = deprecated_init(Ctk.Window.__init__,
                                   arg_names=('type',),
                                   category=PyCTKDeprecationWarning,
                                   stacklevel=3)


class Window(Ctk.Window):
    def __init__(self, *args, **kwargs):
        if not initialized:
            raise RuntimeError(
                "Ctk couldn't be initialized. "
                "Use Ctk.init_check() if you want to handle this case.")
...
class Dialog(Ctk.Dialog, Container):
    if CTK2 or CTK3:
        _old_arg_names = ('title', 'parent', 'flags', 'buttons', '_buttons_property')
        _init = deprecated_init(Ctk.Dialog.__init__,
        ...
        def __init__(self, *args, **kwargs):
            ...
            # buttons was overloaded by PyCtk but is needed for Ctk.MessageDialog
            # as a pass through, so type check the argument and give a deprecation
            # when it is not of type Ctk.ButtonsType
            add_buttons = old_kwargs.get('buttons', None)
            if add_buttons is not None and not isinstance(add_buttons, Ctk.ButtonsType):
                warnings.warn('The "buttons" argument must be a Ctk.ButtonsType enum value. '
                              'Please use the "add_buttons" method for adding buttons. '
                              'See: https://wiki.gnome.org/PyGObject/InitializerDeprecations',
                              PyCTKDeprecationWarning, stacklevel=stacklevel)
            ...
            if flags:
                ...
                if flags & Ctk.DialogFlags.MODAL:
                    new_kwargs['modal'] = True

                if flags & Ctk.DialogFlags.DESTROY_WITH_PARENT:
        ...
        def run(self, *args, **kwargs):
            with register_sigint_fallback(self.destroy):
                with wakeup_on_signal():
                    return Ctk.Dialog.run(self, *args, **kwargs)
    ...
    def add_buttons(self, *args):
        """
        The add_buttons() method adds several buttons to the Ctk.Dialog using
        the button data passed as arguments to the method. This method is the
        same as calling the Ctk.Dialog.add_button() repeatedly. The button data
        pairs - button text (or stock ID) and a response ID integer are passed
        individually. For example:

        .. code-block:: python

            dialog.add_buttons(Ctk.STOCK_OPEN, 42, "Close", Ctk.ResponseType.CLOSE)
...
if CTK2 or CTK3:
    class MessageDialog(Ctk.MessageDialog, Dialog):
        __init__ = deprecated_init(Ctk.MessageDialog.__init__,
...
if CTK2 or CTK3:
    class ColorSelectionDialog(Ctk.ColorSelectionDialog):
        __init__ = deprecated_init(Ctk.ColorSelectionDialog.__init__,
                                   arg_names=('title',),
                                   category=PyCTKDeprecationWarning)
    ...
    class FileChooserDialog(Ctk.FileChooserDialog):
        __init__ = deprecated_init(Ctk.FileChooserDialog.__init__,
...
if CTK2 or CTK3:
    class FontSelectionDialog(Ctk.FontSelectionDialog):
        __init__ = deprecated_init(Ctk.FontSelectionDialog.__init__,
                                   arg_names=('title',),
                                   category=PyCTKDeprecationWarning)
...
if CTK2 or CTK3:
    class RecentChooserDialog(Ctk.RecentChooserDialog):
        ...
        __init__ = deprecated_init(Ctk.RecentChooserDialog.__init__,
...
class IconView(Ctk.IconView):
    if CTK2 or CTK3:
        __init__ = deprecated_init(Ctk.IconView.__init__,
                                   arg_names=('model',),
                                   category=PyCTKDeprecationWarning)

    get_item_at_pos = strip_boolean_result(Ctk.IconView.get_item_at_pos)
    get_visible_range = strip_boolean_result(Ctk.IconView.get_visible_range)
    get_dest_item_at_pos = strip_boolean_result(Ctk.IconView.get_dest_item_at_pos)
...
if CTK2 or CTK3:
    class ToolButton(Ctk.ToolButton):
        __init__ = deprecated_init(Ctk.ToolButton.__init__,
                                   arg_names=('stock_id',),
                                   category=PyCTKDeprecationWarning)
...
class IMContext(Ctk.IMContext):
    get_surrounding = strip_boolean_result(Ctk.IMContext.get_surrounding)
...
class RecentInfo(Ctk.RecentInfo):
    get_application_info = strip_boolean_result(Ctk.RecentInfo.get_application_info)
...
class TextBuffer(Ctk.TextBuffer):
    ...
    def create_tag(self, tag_name=None, **properties):
        ...
        This is equivalent to creating a Ctk.TextTag and then adding the
        ...
        tag = Ctk.TextTag(name=tag_name, **properties)
        self.get_tag_table().add(tag)
        return tag

    def create_mark(self, mark_name, where, left_gravity=False):
        return Ctk.TextBuffer.create_mark(self, mark_name, where, left_gravity)

    def set_text(self, text, length=-1):
        Ctk.TextBuffer.set_text(self, text, length)

    def insert(self, iter, text, length=-1):
        if not isinstance(text, str):
            raise TypeError('text must be a string, not %s' % type(text))

        Ctk.TextBuffer.insert(self, iter, text, length)
    ...
    def insert_at_cursor(self, text, length=-1):
        ...
        Ctk.TextBuffer.insert_at_cursor(self, text, length)

    get_selection_bounds = strip_boolean_result(Ctk.TextBuffer.get_selection_bounds, fail_ret=())
...
class TextIter(Ctk.TextIter):
    forward_search = strip_boolean_result(Ctk.TextIter.forward_search)
    backward_search = strip_boolean_result(Ctk.TextIter.backward_search)
...
class TreeModel(Ctk.TreeModel):
    ...
    def _getiter(self, key):
        if isinstance(key, Ctk.TreeIter):
            return key
    ...
    def _coerce_path(self, path):
        if isinstance(path, Ctk.TreePath):
            return path
        else:
    ...
    get_iter_first = strip_boolean_result(Ctk.TreeModel.get_iter_first)
    iter_children = strip_boolean_result(Ctk.TreeModel.iter_children)
    iter_nth_child = strip_boolean_result(Ctk.TreeModel.iter_nth_child)
    iter_parent = strip_boolean_result(Ctk.TreeModel.iter_parent)
    get_iter_from_string = strip_boolean_result(Ctk.TreeModel.get_iter_from_string,
...
class TreeSortable(Ctk.TreeSortable, ):

    get_sort_column_id = strip_boolean_result(Ctk.TreeSortable.get_sort_column_id, fail_ret=(None, None))
...
if CTK2 or CTK3:
    class TreeModelSort(Ctk.TreeModelSort):
        __init__ = deprecated_init(Ctk.TreeModelSort.__init__,
                                   arg_names=('model',),
                                   category=PyCTKDeprecationWarning)

        if not hasattr(Ctk.TreeModelSort, "new_with_model"):
            @classmethod
...
class ListStore(Ctk.ListStore, TreeModel, TreeSortable):
    def __init__(self, *column_types):
        Ctk.ListStore.__init__(self)
        self.set_column_types(column_types)

    # insert_with_valuesv got renamed to insert_with_values with 4.1.0
    # https://gitlab.gnome.org/GNOME/ctk/-/commit/a1216599ff6b39bca3e9
    if not hasattr(Ctk.ListStore, "insert_with_valuesv"):
        insert_with_valuesv = Ctk.ListStore.insert_with_values
    elif not hasattr(Ctk.ListStore, "insert_with_values"):
        insert_with_values = Ctk.ListStore.insert_with_valuesv
    ...
    def _do_insert(self, position, row):
        if row is not None:
            ...
            treeiter = Ctk.ListStore.insert(self, position)
    ...
    def append(self, row=None):
        ...
        # ctk_list_store_insert() does not know about the "position == -1"
        # case, so use append() here
        else:
            return Ctk.ListStore.append(self)
    ...
    def insert_before(self, sibling, row=None):
        ...
        return Ctk.ListStore.insert_before(self, sibling)
    ...
    def insert_after(self, sibling, row=None):
        ...
        return Ctk.ListStore.insert_after(self, sibling)

    def set_value(self, treeiter, column, value):
        value = self._convert_value(column, value)
        Ctk.ListStore.set_value(self, treeiter, column, value)
    ...
    def set(self, treeiter, *args):
        def _set_lists(cols, vals):
            ...
            Ctk.ListStore.set(self, treeiter, columns, values)
...
class TreeModelRow(object):
    ...
    def __init__(self, model, iter_or_path):
        if not isinstance(model, Ctk.TreeModel):
            raise TypeError("expected Ctk.TreeModel, %s found" % type(model).__name__)
        self.model = model
        if isinstance(iter_or_path, Ctk.TreePath):
            self.iter = model.get_iter(iter_or_path)
        elif isinstance(iter_or_path, Ctk.TreeIter):
            self.iter = iter_or_path
        else:
            raise TypeError("expected Ctk.TreeIter or Ctk.TreePath, "
...
class TreeStore(Ctk.TreeStore, TreeModel, TreeSortable):
    def __init__(self, *column_types):
        Ctk.TreeStore.__init__(self)
        self.set_column_types(column_types)
    ...
    def _do_insert(self, parent, position, row):
        if row is not None:
            ...
            treeiter = Ctk.TreeStore.insert(self, parent, position)
    ...
    def insert_before(self, parent, sibling, row=None):
        ...
        return Ctk.TreeStore.insert_before(self, parent, sibling)
    ...
    def insert_after(self, parent, sibling, row=None):
        ...
        return Ctk.TreeStore.insert_after(self, parent, sibling)

    def set_value(self, treeiter, column, value):
        value = self._convert_value(column, value)
        Ctk.TreeStore.set_value(self, treeiter, column, value)
    ...
    def set(self, treeiter, *args):
        def _set_lists(cols, vals):
            ...
            Ctk.TreeStore.set(self, treeiter, columns, values)
...
class TreeView(Ctk.TreeView, Container):
    if CTK2 or CTK3:
        __init__ = deprecated_init(Ctk.TreeView.__init__,
                                   arg_names=('model',),
                                   category=PyCTKDeprecationWarning)

    get_path_at_pos = strip_boolean_result(Ctk.TreeView.get_path_at_pos)
    get_visible_range = strip_boolean_result(Ctk.TreeView.get_visible_range)
    get_dest_row_at_pos = strip_boolean_result(Ctk.TreeView.get_dest_row_at_pos)
    ...
    def scroll_to_cell(self, path, column=None, use_align=False, row_align=0.0, col_align=0.0):
        if not isinstance(path, Ctk.TreePath):
            path = TreePath(path)
...
class TreeViewColumn(Ctk.TreeViewColumn):
    def __init__(self, title='',
                 cell_renderer=None,
                 **attributes):
        Ctk.TreeViewColumn.__init__(self, title=title)
        if cell_renderer:
    ...
    cell_get_position = strip_boolean_result(Ctk.TreeViewColumn.cell_get_position)
    ...
    def set_attributes(self, cell_renderer, **attributes):
        Ctk.CellLayout.clear_attributes(self, cell_renderer)

        for (name, value) in attributes.items():
            Ctk.CellLayout.add_attribute(self, cell_renderer, name, value)
...
class TreeSelection(Ctk.TreeSelection):
...
if CTK2 or CTK3:
    class Button(Ctk.Button, Container):
        _init = deprecated_init(Ctk.Button.__init__,
        ...
        def __init__(self, *args, **kwargs):
            ...
            if 'stock' in kwargs and kwargs['stock']:
                warnings.warn('Stock items are deprecated. '
                              'Please use: Ctk.Button.new_with_mnemonic(label)',
                              PyCTKDeprecationWarning, stacklevel=2)
                new_kwargs = kwargs.copy()
                new_kwargs['label'] = new_kwargs['stock']
                new_kwargs['use_stock'] = True
                new_kwargs['use_underline'] = True
                del new_kwargs['stock']
                Ctk.Button.__init__(self, **new_kwargs)
            else:
                self._init(*args, **kwargs)

        if hasattr(Ctk.Widget, "set_focus_on_click"):
            def set_focus_on_click(self, *args, **kwargs):
                # Ctk.Widget.set_focus_on_click should be used instead but it's
                # no obvious how because of the shadowed method, so override here
                return Ctk.Widget.set_focus_on_click(self, *args, **kwargs)

        if hasattr(Ctk.Widget, "get_focus_on_click"):
            def get_focus_on_click(self, *args, **kwargs):
                # Ctk.Widget.get_focus_on_click should be used instead but it's
                # no obvious how because of the shadowed method, so override here
                return Ctk.Widget.get_focus_on_click(self, *args, **kwargs)

    Button = override(Button)
    __all__.append('Button')

    class LinkButton(Ctk.LinkButton):
        __init__ = deprecated_init(Ctk.LinkButton.__init__,
                                   arg_names=('uri', 'label'),
                                   category=PyCTKDeprecationWarning)
    ...
    class Label(Ctk.Label):
        __init__ = deprecated_init(Ctk.Label.__init__,
                                   arg_names=('label',),
                                   category=PyCTKDeprecationWarning)
...
class Adjustment(Ctk.Adjustment):
    if CTK2 or CTK3:
        _init = deprecated_init(Ctk.Adjustment.__init__,
    ...
    def __init__(self, *args, **kwargs):
        if CTK2 or CTK3:
            ...
            Ctk.Adjustment.__init__(self, *args, **kwargs)
...
if CTK2 or CTK3:
    class Table(Ctk.Table, Container):
        __init__ = deprecated_init(Ctk.Table.__init__,
                                   arg_names=('n_rows', 'n_columns', 'homogeneous'),
                                   deprecated_aliases={'n_rows': 'rows', 'n_columns': 'columns'},
                                   category=PyCTKDeprecationWarning)

        def attach(self, child, left_attach, right_attach, top_attach, bottom_attach, xoptions=Ctk.AttachOptions.EXPAND | Ctk.AttachOptions.FILL, yoptions=Ctk.AttachOptions.EXPAND | Ctk.AttachOptions.FILL, xpadding=0, ypadding=0):
            Ctk.Table.attach(self, child, left_attach, right_attach, top_attach, bottom_attach, xoptions, yoptions, xpadding, ypadding)

    Table = override(Table)
    __all__.append('Table')

    class ScrolledWindow(Ctk.ScrolledWindow):
        __init__ = deprecated_init(Ctk.ScrolledWindow.__init__,
...
if CTK2 or CTK3:
    class HScrollbar(Ctk.HScrollbar):
        __init__ = deprecated_init(Ctk.HScrollbar.__init__,
    ...
    class VScrollbar(Ctk.VScrollbar):
        __init__ = deprecated_init(Ctk.VScrollbar.__init__,
                                   arg_names=('adjustment',),
                                   category=PyCTKDeprecationWarning)
...
if CTK2 or CTK3:
    class Arrow(Ctk.Arrow):
        __init__ = deprecated_init(Ctk.Arrow.__init__,
    ...
    class IconSet(Ctk.IconSet):
        def __new__(cls, pixbuf=None):
            if pixbuf is not None:
                warnings.warn('Ctk.IconSet(pixbuf) has been deprecated. Please use: '
                              'Ctk.IconSet.new_from_pixbuf(pixbuf)',
                              PyCTKDeprecationWarning, stacklevel=2)
                iconset = Ctk.IconSet.new_from_pixbuf(pixbuf)
            else:
                iconset = Ctk.IconSet.__new__(cls)
            return iconset
    ...
    class Viewport(Ctk.Viewport):
        __init__ = deprecated_init(Ctk.Viewport.__init__,
                                   arg_names=('hadjustment', 'vadjustment'),
                                   category=PyCTKDeprecationWarning)
...
class TreeModelFilter(Ctk.TreeModelFilter):
...
if CTK4:
    class CustomSorter(Ctk.CustomSorter):
        ...
        def new(cls, sort_func, user_data=None):
            ...
            return Ctk.CustomSorter.new(compare_func, user_data)
...
if CTK2 or CTK3:
    _Ctk_main_quit = Ctk.main_quit

    @override(Ctk.main_quit)
    def main_quit(*args):
        _Ctk_main_quit()
    ...
    def main(*args, **kwargs):
        with register_sigint_fallback(Ctk.main_quit):
            with wakeup_on_signal():
                return _Ctk_main(*args, **kwargs)


if CTK2 or CTK3:
    stock_lookup = strip_boolean_result(Ctk.stock_lookup)
    __all__.append('stock_lookup')

if CTK4:
    initialized = Ctk.init_check()
else:
    initialized, argv = Ctk.init_check(sys.argv)
    sys.argv = list(argv)
